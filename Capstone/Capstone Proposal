...
Walk through the application from the user's perspective.
    Optional log in to save places and dates.
    Enter if you are planning for a date right now, or planning for later.
    Select some options:
...
What will they see on each page? What can they input and click and see?
    ...
    Page 2: enter criteria. Button to enter info. Pop-up or filler text of planning
    Page 3: Option to send info to phone, to email, to save for later (sign up for account), display
    Page 4: create account (name, user name, pw, email, phone, save preferences, saved dates. Connect users?)
